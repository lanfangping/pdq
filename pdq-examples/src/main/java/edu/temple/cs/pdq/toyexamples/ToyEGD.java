...
//		this.facts.add(f3);
		...
		Atom f1 = Atom.create(this.getRelations()[0], new Term[] {TypedConstant.create("x_f1"), TypedConstant.create(12), TypedConstant.create(13), TypedConstant.create(1), TypedConstant.create(2)});
		Atom f2 = Atom.create(this.getRelations()[0], new Term[] {TypedConstant.create("x_f2"), TypedConstant.create(11), TypedConstant.create(13), TypedConstant.create(1), TypedConstant.create(2)});
		Atom f3 = Atom.create(this.getRelations()[0], new Term[] {TypedConstant.create("x_f"), TypedConstant.create(12), TypedConstant.create(13), TypedConstant.create(2), TypedConstant.create(13)});
		this.facts = new ArrayList<Atom>();
		this.facts.add(f1);
		this.facts.add(f2);
...
//				);
		...
		this.dependencies = new Dependency[] {e1};
	}
